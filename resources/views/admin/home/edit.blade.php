...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('message.update', ['id' => $message->id]) }}" method="post">
            @csrf
            <h5 class="mb-4">Editar Mensagem #{{$message->id}} - Enviada em: {{date('d/m/Y', strtotime($message->date_register))}}</h5>
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-success">Editar Mensagem</button>
        </form>
    </div>
